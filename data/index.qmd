...
```{ojs}
subject ? html`<p>&nbsp;</p> ` : html`<p>Blättern Sie durch die Daten - wählen Sie das Fach!</p>`
```
...
```{ojs}
viewof subject = Inputs.radio(["V3 Mathematik", "V3 Deutsch", "V8 Mathematik", "V8 Deutsch", "V8 Englisch", "V8 Französisch"], {label: "Fach"})
```
